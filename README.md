...
- [Функционал приложения валидатора не принимает некоторые типы карт.](https://github.com/iamlenulya/JAVA-L-2/issues/1#issue-770311382)
- [Функционал приложения валидатора не принимает 19-тизначные номера карт](https://github.com/iamlenulya/JAVA-L-2/issues/2#issue-770315185)
